      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "40px" }}>
        <div style={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1", minWidth: "300px" }}>
            <h1 style={{ color: "#335C67", marginBottom: "15px", fontSize: "28px" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: "24px", fontWeight: "bold", color: vehicle.onSale ? "#9E2A2B" : "#335C67" }}>
                  ${vehicle.price}
                </span>
                {vehicle.onSale && (
                  <span style={{ backgroundColor: "#9E2A2B", color: "white", padding: "5px 10px", borderRadius: "5px", fontSize: "14px" }}>
                    Hot Deal
                  </span>
                )}
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "15px", marginBottom: "20px" }}>
              <div style={{ backgroundColor: "#FFFFFF", padding: "15px", borderRadius: "5px", border: "1px solid #D9D9D9" }}>
              ...
              >
                {showCO2 ? (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" }}>
                    <div style={{ color: "#1976D2", fontSize: "14px", textAlign: "center", marginBottom: "5px" }}>Wondering about</div>
                    <div style={{ color: "#1976D2", fontWeight: "bold", textAlign: "center", fontSize: "16px" }}>CO2 Emissions?</div>
                    <div style={{ color: "#1976D2", fontSize: "12px", textAlign: "center", marginTop: "5px" }}>Click to reveal</div>
                  </div>
                )}
              </div>
        ...
        <div style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "5px", border: "1px solid #D9D9D9", marginTop: "20px" }}>
          <h3 style={{ color: "#335C67", marginBottom: "15px" }}>Vehicle Description</h3>
